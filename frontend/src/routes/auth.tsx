        ...
        <Card className="glass p-6">
          ...
          <div className="relative mt-6 mb-4">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-transparent px-2 text-muted-foreground" style={{ backgroundColor: 'var(--card)' }}>OR</span>
            </div>
          </div>
          ...
          <Button 
            ...
            type="button" 
            disabled={loading} 
            className="w-full bg-[#0a0a0a] border-slate-800 hover:bg-[#1f1f1f] text-white"
            onClick={async () => {
              setLoading(true);
